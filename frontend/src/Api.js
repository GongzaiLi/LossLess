...
export default {
  ...
  getUser: (id) => instance.get(`users/${id}`, {withCredentials: false}),
  ...
  searchUser: (searchParameter) => instance.get(`users/search?searchQuery=${searchParameter}`, {withCredentials: false}),

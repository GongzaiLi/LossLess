...
public class ProductService {
     ...
     */
    public Integer getTotalProductsCountByBusinessId(Integer id, String productName) {
        return productRepository.countProductByBusinessIdAndNameContainsAllIgnoreCase(id, productName);
    }
     ...
     */
    public List<Product> searchCountProductsByBusinessIdFromOffset(Integer id, Integer offset, Integer count, GetProductSortTypes sortBy, String sortDirection, String searchQuery) {
        ...
        return  productRepository.findAllByBusinessIdAndNameContainsAllIgnoreCase(id, searchQuery, pageable);
    }

...
public class SalesReportPurchaseTotalsDto {
    private Product product;
    private Integer totalProductPurchases;
    private Double totalValue;
    private Integer totalLikes;

    public SalesReportPurchaseTotalsDto(Product product, Integer totalProductPurchases, Double totalValue, Integer totalLikes) {
        setProduct(product);

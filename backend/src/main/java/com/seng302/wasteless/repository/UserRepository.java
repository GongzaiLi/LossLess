...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query(value = "select id from User where id in (select User_id from User_listingsLiked where listingsLiked_id = :listingId)", nativeQuery = true)
    List<Integer> findAllByLikedListingId(@Param("listingId") Integer likedListingId);
